...
public extension String {
  ...
  @inlinable subscript(r: Range<Int>) -> String {
  ...
  @inlinable func at(_ index: Int) -> String? {
  ...
  @available(*, deprecated, message: "Use native Swift's `.hasSuffix(...)` instead")
  @inlinable func endsWith(_ characters: String) -> Bool {
    return hasSuffix(characters)
  }
  ...
  @inlinable func includes(_ characters: String) -> Bool {
  ...
  @inlinable func indexOf(_ characters: String) -> Int {
  ...
  @inlinable func lastIndexOf(_ characters: String) -> Int {
  ...
  @available(*, deprecated, message: "Use native Swift's `String(repeating: ..., count: ...)` instead")
  @inlinable func repeatJs(_ count: Int) -> String {
  ...
  @available(*, deprecated, message: "Use native Swift's `.replacing(..., with: ..., maxReplacements: 1)` instead")
  @inlinable func replace(_ characters: String, _ with: String) -> String {
  ...
  @inlinable func replaceAll(_ characters: String, _ with: String) -> String {
  ...
  @inlinable func slice(_ start: Int, _ end: Int? = nil) -> String {
    // Convert negative to positive index
  ...
  @inlinable func split(_ separator: Character) -> [String] {
  ...
  /// - SeeAlso: JS Docs: [developer.apple.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/split)
  @inlinable func split(_ delimiter: String) -> [String] {
  ...
  @available(*, deprecated, message: "Use native Swift's `.hasPrefix(...)` instead")
  @inlinable func startsWith(_ characters: String) -> Bool {
  ...
  @available(*, deprecated, message: "Use native Swift's `.lowercased` instead")
  @inlinable func toLowerCase() -> String {
    return lowercased()
  }
  ...
  @available(*, deprecated, message: "Use native Swift's `.uppercased` instead")
  @inlinable func toUpperCase() -> String {
    return uppercased()
  }
  ...
  @inlinable func trimStart() -> String {
    let characterSet = CharacterSet.whitespacesAndNewlines
