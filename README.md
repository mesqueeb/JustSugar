...
```
.package(url: "https://github.com/mesqueeb/JustSugar", from: "0.0.5")
```
...
See the [documentation](https://swiftpackageindex.com/mesqueeb/justsugar/v0.0.5/documentation/justsugar/swift) for more info.
