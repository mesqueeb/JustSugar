...
@Test func arrayLastIndex() throws {
...
@Test func arrayToSpliced() throws {
  let array = [1, 2, 3, 4, 5]
...
@Test func arrayToReversed() throws {
  let array = [1, 2, 3, 4, 5]
  #expect(array.toReversed() == [5, 4, 3, 2, 1])
  #expect(array == [1, 2, 3, 4, 5])
}

@Test func arrayToSorted() throws {
  let array = [1, 5, 3, 0]
  #expect(array.toSorted() == [0, 1, 3, 5])
  #expect(array == [1, 5, 3, 0])
}

@Test func arrayUnshift() throws {
  var arr = [0, 1, 5]
