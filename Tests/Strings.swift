...
struct StringTests {
  ...
  @Test func replace() throws {
    #expect(
      "The quick brown fox jumps over the lazy fox.".replace("fox", "ox")
        == "The quick brown ox jumps over the lazy fox."
    )
    #expect("".replace("a", "b") == "")
  }
  ...
  @Test func replaceAll() throws {
    #expect(
      "The quick brown fox jumps over the lazy fox.".replaceAll("fox", "ox")
        == "The quick brown ox jumps over the lazy ox."
    )
    #expect("".replaceAll("a", "b") == "")
  }

  @Test func replacing_with_regex() throws {
    #expect(
      "The quick brown fox jumps over the lazy fox.".replacing(/fox/, with: "ox")
        == "The quick brown ox jumps over the lazy ox."
    )
    #expect("".replacing(/a/, with: "b") == "")
  }
